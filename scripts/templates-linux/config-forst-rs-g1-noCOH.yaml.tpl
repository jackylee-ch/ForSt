...
env.java.opts.taskmanager: -Dforstrs.native.libpath=/Users/lijunqing/Downloads/workenv/flink-2.2.1/lib/libforst_rs_ffi.so --enable-native-access=ALL-UNNAMED --add-modules jdk.incubator.vector -XX:+UseG1GC 
env.java.opts.jobmanager: --enable-native-access=ALL-UNNAMED --add-modules jdk.incubator.vector -XX:+UseG1GC 
